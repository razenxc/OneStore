...
namespace OneStore.Services
{
    public class JwtService : IJwtService
    {
        ...
        public async Task<Tokens> RefreshTokenAsync(User user)
        {
            if (user == null)
            {
                return null;
            ...
            JwtRefreshToken oldRefreshToken = await _context.JwtRefreshTokens.FirstOrDefaultAsync(x => x.UserId == user.Id);
